...
<Tabs items={['Javascript', 'Ruby', 'PHP','Pyhton']}>
  <Tabs.Tab style={{ color: 'white', background: 'black',minHeight:'5rem',padding:'2rem',marginTop:'1rem' }}>**Curl**:package manager for the curl language. </Tabs.Tab>
  <Tabs.Tab style={{ color: 'white', background: 'black',minHeight:'5rem',padding:'2rem',marginTop:'1rem'  }}>**JavaScript** is a package manager for the JavaScript programming language.</Tabs.Tab>
  <Tabs.Tab style={{ color: 'white', background: 'black',minHeight:'5rem',padding:'2rem',marginTop:'1rem'  }}>**Ruby** is a software packaging system.</Tabs.Tab>
  <Tabs.Tab style={{ color: 'white', background: 'black',minHeight:'5rem',padding:'2rem' ,marginTop:'1rem'  }}>**Pyhton** is a software packaging system.</Tabs.Tab>
</Tabs>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 mt-10">
  <div className="rounded-lg border text-card-foreground shadow-sm bg-gray-100">
    <div className="flex flex-col space-y-1.5 p-6">
      <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Ruby</h3>
    </div>
    <div className="p-6">
  ...
  <div className="rounded-lg border text-card-foreground shadow-sm bg-gray-100">
    <div className="flex flex-col space-y-1.5 p-6">
      <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Python</h3>
    </div>
    <div className="p-6">
        A dynamic, open source programming language with a focus on simplicity and productivity.
    </div>
  ...
  <div className="rounded-lg border text-card-foreground shadow-sm bg-gray-100">
    <div className="flex flex-col space-y-1.5 p-6">
      <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Node.js</h3>
    </div>
    <div className="p-6">
        A dynamic, open source programming language with a focus on simplicity and productivity.
    </div>
