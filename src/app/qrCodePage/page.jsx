...
import { Box, Button, IconButton, StackDivider, Text, VStack } from '@chakra-ui/react';
      ...
      navigator.share({
        ...
        .then(
          toast({
            ...
            description:
              "Meanwhile please explore our products",
            status: "success",
            duration: 3000,
            isClosable: true,
          })
    ...
    <Box bg="black" minH="100vh" p={4} color="white" position={'relative'} mt={'1rem'} zIndex={'999999999'}>
      <VStack spacing={4} mt={'6rem'}>
        ...
        {/* <QRCode size='40' fgColor='#FFFFFF' logoOpacity={'0.5'} bgColor='transparent'	 quietZone={'0'} logoPaddingStyle='square' logoPadding='0' value="https://github.com/gcoro/react-qrcode-logo"/> */}
          ...
          <Text mt={'0.5rem'} fontSize={'12px'} fontWeight={'400'} align={'center'} color={'#949494'} lineHeight={'14.4px'}>Scan to save their digital profile and network</Text>
        </Box>
        <Button
          leftIcon={<CiShare2 stroke='black' />} 
          bg={'white'}
          color={'black'}
          onClick={handleShare}
        >
